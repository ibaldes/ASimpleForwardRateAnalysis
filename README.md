Report and code for an analysis of a simple forward rate. The ASimpleForwardRateReport.pdf file gives an overview of the findings and the methods used in the code.
